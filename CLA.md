...
property rights granted with Contributions to the Project. It protects You as a
contributor and the Licensor, and it preserves the Licensor's ability to offer
the Project under multiple licenses (including commercial licenses) and to
relicense future versions.

**By submitting a Contribution to the Project (for example, opening a pull
request), You agree to the terms of this Agreement.**
...
- **"Contribution"** means any original work of authorship — including any
  ...
  the Project for inclusion in it, in any form.

## 2. Copyright License

You retain ownership of the copyright in Your Contribution. You hereby grant to
the Licensor a **perpetual, worldwide, non-exclusive, royalty-free,
irrevocable** license to reproduce, prepare derivative works of, publicly
display, publicly perform, and distribute Your Contribution and such derivative
works, **with the right to sublicense and to license the Contribution under any
terms**, including open-source, source-available, or proprietary/commercial
terms, and to relicense future versions of the Project. This allows the Licensor
to distribute the Project under the Apache License 2.0 with the Commons Clause,
to offer separate commercial licenses, and to change the Project's license going
forward.

## 3. Patent License

You hereby grant to the Licensor and to recipients of the Project a
...
- Each Contribution is Your original creation, or You otherwise have the right to
...
KIND**, either express or implied. The Licensor is under no obligation to accept,
use, or include any Contribution in the Project.

---

*This CLA is a template provided for convenience and is not legal advice.
